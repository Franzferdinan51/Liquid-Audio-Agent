...
import { generateResponse, executeN8NWorkflow } from './services/geminiService';
        ...
        try {
            ...
            if (responsePart?.functionCall) {
                ...
                const toolMessage: Message = {
                 ...
                 // Execute the actual N8N workflow
                 updateWorkflowStep('Executing N8N Workflow', true);
                 const executionResult = await executeN8NWorkflow(workflowName, connectionSettings);
