...
export const SettingsModal: React.FC<SettingsModalProps> = ({ onClose, onSave, currentSettings }) => {
    ...
    const handleFetchWorkflows = async () => {
        ...
        try {
            ...
            // Create N8N service and test connection
            const n8nService = createN8NService(settings);
            ...
            // Fetch workflows using the service
            const fetchedWorkflows = await n8nService.fetchWorkflows();
                ...
                <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="p-4 bg-black/20 rounded-lg space-y-4 border border-white/10">
                        ...
                        <div className="text-xs text-gray-400 mt-2 p-2 bg-black/30 rounded-md">
                            ...
                            <span className="block mt-2 mb-2"><strong>Quick Fix (Recommended):</strong></span>
                            <code className="bg-stone-700 p-1 rounded mx-1 text-white text-[11px] block mb-1">Windows: fix-cors.bat</code>
                            <code className="bg-stone-700 p-1 rounded mx-1 text-white text-[11px] block mb-2">Linux/Mac: ./fix-cors.sh</code>

                            <span className="block mt-2 mb-1"><strong>Manual Configuration:</strong></span>
                            <code className="bg-stone-700 p-1 rounded mx-1 text-white text-[11px] block">N8N_CORS_ALLOW_ORIGIN=*</code>
                            <code className="bg-stone-700 p-1 rounded mx-1 text-white text-[11px] block">N8N_CORS_CREDENTIALS=true</code>
                            <code className="bg-stone-700 p-1 rounded mx-1 text-white text-[11px] block">N8N_CORS_METHODS=GET,POST,PUT,DELETE,OPTIONS,PATCH</code>
                        </div>
                    </div>
                </div>
